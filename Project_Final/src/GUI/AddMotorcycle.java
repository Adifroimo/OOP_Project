...
public class AddMotorcycle extends JInternalFrame {
	...
	public AddMotorcycle() {
		...
		btnNewButton.setBounds(299, 177, 89, 23);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(btnNewButton, "Invalid Year", "Invalid Year", JOptionPane.ERROR_MESSAGE);
						...
						Motorcycle h1= new Motorcycle(Double.parseDouble(textField_1.getText()),Integer.parseInt(textField_2.getText()),(Color)comboBox.getSelectedItem(),Integer.parseInt(textField.getText()),Double.parseDouble(textField_3.getText()),Integer.parseInt(textField_4.getText()),rdbtnNewRadioButton.isSelected());
