...
public class AddHybridCar extends JInternalFrame {
	...
	public AddHybridCar() {
		...
		btnNewButton.setBounds(301, 161, 89, 23);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(btnNewButton, "Invalid Year", "Invalid Year", JOptionPane.ERROR_MESSAGE);
					...
					HybridCar h1= new HybridCar(Double.parseDouble(textField_1.getText()),Integer.parseInt(textField_2.getText()),(Color)comboBox.getSelectedItem(),Integer.parseInt(textField.getText()),Double.parseDouble(textField_3.getText()),Integer.parseInt(textField_4.getText()),Integer.parseInt(textField_5.getText()),rdbtnNewRadioButton.isSelected());
